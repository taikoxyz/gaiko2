...
assert_contains '"path": "tdx/mkosi.build"'
assert_contains '"path": "tdx/mkosi.postinst"'
assert_contains '"kernel_cmdline": "console=tty0 console=ttyS0,115200n8 mitigations=auto,nosmt spec_store_bypass_disable=on"'
